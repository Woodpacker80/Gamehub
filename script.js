...
function updateTurnUI(){
  ...
  const _vc=G.vowelCost||VOWEL_COST; document.getElementById('btn-vowel').disabled = !(isP&&(G.phase==='spin'||G.phase==='guess')&&!G.locked&&G.roundScore.player>=_vc&&hasUnrevealedVowels()&&!G.suddenDeath);
