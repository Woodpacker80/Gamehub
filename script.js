...
function updateTurnUI(){
  ...
  const _vc=G.vowelCost||VOWEL_COST; document.getElementById('btn-vowel').disabled = !(isP&&G.hasGuessed&&G.phase==='spin'&&!G.locked&&G.roundScore.player>=_vc&&hasUnrevealedVowels()&&!G.suddenDeath);
...
function handleBuyVowel(){
  if(G.turn!=='player'||!G.hasGuessed||G.phase!=='spin'||G.locked) return;
