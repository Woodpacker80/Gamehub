...
function startRound(){
  ...
  if(roundType !== 'normal'){
    ...
    if(roundType === 'gold'){
      title = '👑 Gold Round!';
      body  = 'A Gold BONUS tile (+$5,000) lands next to Bankrupt and a Silver BONUS tile (+$2,500) is also on the wheel. Land on BONUS and guess a correct consonant to collect it! One Lose a Turn becomes Minus (−50%). Vowels cost $500 this round!';
      icon  = '👑';
    } else {
      title = '🥈 Silver Round!';
