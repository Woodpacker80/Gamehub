...
function startRound(){
  ...
  if(roundType === 'gold'){
    ...
    pill.textContent = '⭐ Silver Round ' + G.round + ' of ' + G.maxRounds;
  ...
  if(roundType !== 'normal'){
    ...
    if(roundType === 'gold'){
      title = '👑 Gold Round!';
      body  = 'Gold Bonus (+$5,000) lands next to Bankrupt. Silver Bonus (+$2,500) is also on the wheel. One Lose a Turn is now Minus (−50%). Vowels cost $500 this round!';
      icon  = '✨';
    } else {
      title = '⭐ Silver Round!';
      body  = 'Silver Bonus tile: land it + correct consonant = earnings + $2,500! Minus tile: lose 50% round earnings!';
      icon  = '⚡';
    }
    setTimeout(()=>{
