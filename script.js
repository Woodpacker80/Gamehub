...
function updateTurnUI(){
  ...
  const _vc=G.vowelCost||VOWEL_COST; document.getElementById('btn-vowel').disabled = !(isP&&(G.phase==='guess'||(G.phase==='spin'&&G.hasGuessed))&&!G.locked&&G.roundScore.player>=_vc&&hasUnrevealedVowels()&&!G.suddenDeath);
...
async function loadAllLbQuadrants(){
  ...
  function renderQuadrant(id, entries){
    ...
    el.innerHTML = entries.slice(0,15).map((e,i)=>{
